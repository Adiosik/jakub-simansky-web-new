...
export const csCZ: Translation = {
  ...
  hero: {
    photoAlt: "Kresba hlavy — obal alba Bez Niesnera",
  },
  now: {
    title: "aktuálně",
    lead: "Jakub Šimanský ve spolupráci s brněnským kulturním družstvem KAFARA vydává nové sólové album s názvem „Bez Niesnera“.",
    body: "Datum vydání je plánováno na 10. září a bude k dispozici na cédéčkách, kazetách a vybraných streamovacích platformách. Na albu je devět zhudebněných příběhů, které oscilují mezi Jakubovým dětstvím, dospíváním a současností a dohromady skládají pomníček divnostem všedního dne v českém kontextu, kde to dobré je často skryté. Od legendárních postav santusáků, přes oblíbený zákusek babičky, který už skoro nikdo nezná, až po nesmrtelné hlášky zmařených talentů. Všechen ten veselý maloměstský folklór, který někdy může zásadně ovlivnit váš život jako základní motiv. V hudbě se jasně projevuje radost a hravost, přibyly nové kombinace banja, kytary, lap steel kytary a perkusí, včetně elektroniky a field-recordingu a s nimi nejen důraz na melodii jako nosný prvek příběhu, ale také na nadsázku a ironii. Bavit se je cíl. Jakub album nahrál a mixoval na jaře 2026 v Brně a v Přerově, stejně tak je autorem obalu. Na hudbě se podílel harmonikou Ján Podracký, Tomáš Niesner se postaral o finální zvuk a Oliver Quinn vyrobil design CD a MC.",
    meta: "10. září 2026 · CD, kazeta a vybrané streamovací platformy",
  },
  footer: {
    copy: "Kopírovat",
    copied: "Zkopírováno",
